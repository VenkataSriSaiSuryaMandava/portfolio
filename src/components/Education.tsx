...
/**
 * Education
 * Clean stacked cards with institution logos.
 */
  ...
  return (
    <section id="education" className="py-20 scroll-mt-28">
      <div className="mx-auto max-w-6xl px-4">
        <SectionHeading
          title="Education"
          subtitle="Academic foundation & focus areas"
        />
              ...
              <div className="p-6 sm:p-7">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div className="flex gap-5 items-start">
                    {/* Institution logo */}
                    {edu.logo ? (
                      <div className="relative h-16 w-16 sm:h-18 sm:w-18 shrink-0 flex items-center justify-center rounded-xl bg-white/70 dark:bg-black/30 border border-black/5 dark:border-white/10">
                        <Image
                          src={edu.logo}
