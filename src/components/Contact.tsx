...
const LINKS = {
  ...
  leetcode: "https://leetcode.com/u/mandavavenkatasrisaisurya/",
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (!canSubmit) {
      setStatus({
        state: "error",
        message:
          "Please fill all fields (message at least 10 characters).",
      });
      return;
    }
      ...
      <div className="mt-14 grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
        ...
        <SectionReveal delay={0.05}>
          <motion.div
            ...
            className="card-surface card-hover p-6 sm:p-8"
          >
        ...
        <SectionReveal delay={0.1}>
          <motion.div
            ...
            viewport={{ once: true, amount: 0.35 }}
            transition={{ duration: reduce ? 0 : 0.5 }}
            className="relative card-surface card-hover p-6 sm:p-8 overflow-hidden"
          >
            {/* Glow */}
            <div className="pointer-events-none absolute -inset-1 rounded-3xl bg-gradient-to-br from-primary/25 via-indigo-500/10 to-cyan-400/25 blur-xl opacity-60" />
            ...
            <div className="relative">
              ...
              Feel free to reach out if you are looking for a software engineer, have a question,
              want to explore my work, or just want to connect.
              </p>
...
function Social({
  ...
  return (
    ...
    >
      <span className="text-lg text-gray-700 dark:text-gray-200 group-hover:text-primary transition-colors">
        {icon}
      </span>
